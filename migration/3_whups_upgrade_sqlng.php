...
class WhupsUpgradeSqlng extends Horde_Db_Migration_Base
{
    ...
    public function up()
    {
        $t = $this->createTable('whups_sharesng', ['autoincrementKey' => 'share_id']);
        ...
        $this->addIndex('whups_sharesng', ['share_name']);
        $this->addIndex('whups_sharesng', ['share_owner']);
        $this->addIndex('whups_sharesng', ['perm_creator_' . Horde_Perms::SHOW]);
        $this->addIndex('whups_sharesng', ['perm_creator_' . Horde_Perms::READ]);
        $this->addIndex('whups_sharesng', ['perm_creator_' . Horde_Perms::EDIT]);
        $this->addIndex('whups_sharesng', ['perm_creator_' . Horde_Perms::DELETE]);
        $this->addIndex('whups_sharesng', ['perm_default_' . Horde_Perms::SHOW]);
        $this->addIndex('whups_sharesng', ['perm_default_' . Horde_Perms::READ]);
        $this->addIndex('whups_sharesng', ['perm_default_' . Horde_Perms::EDIT]);
        $this->addIndex('whups_sharesng', ['perm_default_' . Horde_Perms::DELETE]);
        $this->addIndex('whups_sharesng', ['perm_guest_' . Horde_Perms::SHOW]);
        $this->addIndex('whups_sharesng', ['perm_guest_' . Horde_Perms::READ]);
        $this->addIndex('whups_sharesng', ['perm_guest_' . Horde_Perms::EDIT]);
        $this->addIndex('whups_sharesng', ['perm_guest_' . Horde_Perms::DELETE]);

        $t = $this->createTable('whups_sharesng_groups', ['autoincrementKey' => false]);
        ...
        $this->addIndex('whups_sharesng_groups', ['share_id']);
        $this->addIndex('whups_sharesng_groups', ['group_uid']);
        $this->addIndex('whups_sharesng_groups', ['perm_' . Horde_Perms::SHOW]);
        $this->addIndex('whups_sharesng_groups', ['perm_' . Horde_Perms::READ]);
        $this->addIndex('whups_sharesng_groups', ['perm_' . Horde_Perms::EDIT]);
        $this->addIndex('whups_sharesng_groups', ['perm_' . Horde_Perms::DELETE]);

        $t = $this->createTable('whups_sharesng_users', ['autoincrementKey' => false]);
        $t->column('share_id', 'integer', ['null' => false]);
        ...
        $this->addIndex('whups_sharesng_users', ['share_id']);
        $this->addIndex('whups_sharesng_users', ['user_uid']);
        $this->addIndex('whups_sharesng_users', ['perm_' . Horde_Perms::SHOW]);
        $this->addIndex('whups_sharesng_users', ['perm_' . Horde_Perms::READ]);
        $this->addIndex('whups_sharesng_users', ['perm_' . Horde_Perms::EDIT]);
        $this->addIndex('whups_sharesng_users', ['perm_' . Horde_Perms::DELETE]);
