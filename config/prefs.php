 ...
 * Local overrides ONLY MUST be placed in var/config/whups/prefs.local.php or
 * var/config/whups/prefs.d/.
 * If the 'vhosts' setting has been enabled in Horde's configuration, you can
 * use var/config/whups/prefs-servername.php.
 */
...
$_prefs['summary_show_ticket_numbers'] = [
    'value' => 1,
    'type' => 'checkbox',
