...
class Whups_Form_TicketDetails extends Horde_Form
{
    ...
    public function __construct($vars, $ticket, $title = '')
    {
        ...
        $date_params = [$GLOBALS['prefs']->getValue('date_format')];
        $fields = ['summary', 'queue', 'version', 'type', 'state',
                ...
                switch ($field) {
                    ...
                    case 'owner':
                        $owner = $this->addVariable(
                            ...
                            false,
                            null,
                            [true, $GLOBALS['conf']['prefs']['obfuscate_email']]
                        );
                    ...
                    case 'requester':
                        $this->addVariable(
                            ...
                            false,
                            null,
                            [false, $GLOBALS['conf']['prefs']['obfuscate_email']]
                        );
                        break;
